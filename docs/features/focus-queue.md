...
Behind the scenes, every action item is part of a [plan](/docs/features/plans). Most items start as simple, single-step actions. But when an item turns out to be more involved, FlowMail can break it down into sub-steps — so you're never staring at a vague to-do wondering where to start.

## Task Types

Inspired by [Getting Things Done (GTD)](https://gettingthingsdone.com/), every item in the Focus Queue has a clear type that tells you what kind of action is needed:
